...
public class ExifHelper {
     ...
     * @throws IOException
     */
    public ExifHelper createInFile(String filePath) throws IOException {
     ...
     * @throws IOException
     */
    public ExifHelper createOutFile(String filePath) throws IOException {
     ...
     */
    public ExifHelper readExifData() {
     ...
     * @throws IOException
     */
    public ExifHelper writeExifData() throws IOException {
